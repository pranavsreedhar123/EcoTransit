...
const RouteValues = (props) => {
  ...
  return (
    ...
    <Navbar/>
    <Center>
    <VStack spacing={1} paddingTop={100} alignItems={"flex-start"} fontSize={25}>
        <Box bg ='green.100' minW={450} borderColor={"gray"} borderWidth='2px' borderRadius='lg' padding={2}>
        <h1>
          <b>Drive: </b>
        </h1>
        <li>
