...
class MapControllerTest {
    ...
    void getMap() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/getLocation/{dest_address}/{origin_address}", "New York", "Nashville")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.originlat").isString())
                .andExpect(MockMvcResultMatchers.jsonPath("$.originlng").isString())
                .andExpect(MockMvcResultMatchers.jsonPath("$.destinationlat").isString())
                .andExpect(MockMvcResultMatchers.jsonPath("$.destinationlng").isString())
